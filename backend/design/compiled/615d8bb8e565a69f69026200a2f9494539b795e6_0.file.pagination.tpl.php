<?php
/* Smarty version 3.1.38, created on 2021-03-15 07:01:11
  from 'C:\OpenServer\domains\hand-art.loc\backend\design\html\pagination.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_604edc07118fa1_05581776',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '615d8bb8e565a69f69026200a2f9494539b795e6' => 
    array (
      0 => 'C:\\OpenServer\\domains\\hand-art.loc\\backend\\design\\html\\pagination.tpl',
      1 => 1554884186,
      2 => 'file',
    ),
  ),
...
function content_604edc07118fa1_05581776 (Smarty_Internal_Template $_smarty_tpl) {
...
">1</a>
    ...
    <?php
$__section_pages_4_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['page_to']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_pages_4_start = (int)@$_smarty_tpl->tpl_vars['page_from']->value < 0 ? max(0, (int)@$_smarty_tpl->tpl_vars['page_from']->value + $__section_pages_4_loop) : min((int)@$_smarty_tpl->tpl_vars['page_from']->value, $__section_pages_4_loop);
$__section_pages_4_total = min(($__section_pages_4_loop - $__section_pages_4_start), $__section_pages_4_loop);
$_smarty_tpl->tpl_vars['__smarty_section_pages'] = new Smarty_Variable(array());
if ($__section_pages_4_total !== 0) {
for ($__section_pages_4_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_pages']->value['index'] = $__section_pages_4_start; $__section_pages_4_iteration <= $__section_pages_4_total; $__section_pages_4_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_pages']->value['index']++){
?>
